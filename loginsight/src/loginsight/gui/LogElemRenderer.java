...
public class LogElemRenderer extends XYDotRenderer {
	...
	public void drawItem(Graphics2D g2,
        ...
        if (!Double.isNaN(y)) {
            ...
            if (orientation == PlotOrientation.HORIZONTAL) {
                ...
                g2.drawString("Test XYZ", (int) transY+10, (int) transX);
                g2.setColor(cr);
            }
                ...
                Color cr = g2.getColor();
                g2.setColor(Color.black);
                g2.drawString("Test XYZ", (int) transX, (int) transY+10);
                g2.setColor(cr);
            }
