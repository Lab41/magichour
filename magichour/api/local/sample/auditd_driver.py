...
log_file = os.path.join(input_dir, "audit.log.gz")
auditd_templates_file = os.path.join(data_dir, "auditd_template_ids.csv")
...
def main():
    ...
    loglines =preprocess_auditd_step(log_file)
